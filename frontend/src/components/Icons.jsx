    ...
    <div className='lg:px-10 sm:px-5 fixed bottom-5 z-30'>
        <div className='flex justify-between items-center gap-5'>
          ...
          <a href="https://wa.me/08126829146">
            <button className='lg:w-[55px] sm:h-[35px] sm:w-[35px] lg:h-[55px] items-center justify-center cursor-pointer shadow-sm shadow-rgba(0, 0, 0, 0.1) 0px 4px 12px]  rounded-[50%] bg-[#087c23] text-white flex sm:text-[16px] lg:text-[24px]'><RiWhatsappFill /></button>
          </a>
          </div>
        </div>
      </div>
